...
public:
	...
	static const VectorR2 Zero;	// a zero value (如果在CPP文件中没有为它初使化,则它会调用默认构造函数来初使化,安全做法是显示为它做初使化)
...
public:
	...
	VectorHgR2( double xVal, double yVal, double wVal ): x(xVal), y(yVal), w(wVal) {}
...
//****************************************************************************
// Matrix2x2 　矢量类	base class for 2x2 matrices 
//****************************************************************************
class Matrix2x2 {
